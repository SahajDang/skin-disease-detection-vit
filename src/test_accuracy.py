...
class FocalLoss(tf.keras.losses.Loss):
    def __init__(self, gamma=2.0, alpha=0.25, name="focal_loss", reduction=tf.keras.losses.Reduction.SUM_OVER_BATCH_SIZE):
